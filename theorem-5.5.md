...
--     f x =_{B} f y
--   := \A -> \B -> \x -> \y -> \f -> \p ->
--     transport A (\a -> f x =_{B} f a) x y p refl_{f x}
...
--      (\c -> (first (second A=B)) ((first (second (B=C))) c),
--      (\a -> 
--         concat A
--           ((first (second A=B)) ((first (second B=C)) ((first B=C) ((first A=B) a))))
--           ((first (second A=B)) ((first A=B) a))
--           a
--           (maponpath B A
--                 ((first (second B=C)) ((first B=C) ((first A=B) a))) -- should be inferred
--                 ((first A=B) a) -- should be inferred
--                 (first (second A=B))
--                 ((first (second (second B=C))) ((first A=B) a)))
--           ((first (second (second A=B))) a),
--       \c ->
--         concat C
--           ((first B=C) ((first A=B) ((first (second A=B)) ((first (second B=C)) c))))
--           ((first B=C) ((first (second B=C)) c))
--           c
--           (maponpath B C
--                 ((first A=B) ((first (second A=B)) ((first (second B=C)) c))) -- should be inferred
--                 ((first (second B=C)) c) -- should be inferred
--                 (first B=C)
--                 ((second (second (second A=B))) ((first (second B=C)) c)))
...
--     (A=A' : Eq A A') ->
--     Eq (∑ (a : A), B a)
--        (∑ (a : A'), B ((first (second A=A')) a))
--   := \A -> \B -> \A' -> \A=A' ->
--     (\(a, b) -> ((first A=A') a,
--       transport A B
--         a ((first (second A=A')) ((first (A=A')) a))
--         (rev A ((first (second A=A')) ((first (A=A')) a)) a
--           ((first (second (second A=A'))) a))
--         b),
--     (\(a', b') -> ((first (second A=A')) a', b'),
--     (\ab -> transport ,
--      \a'b' -> refl_{a'b'})))
```
